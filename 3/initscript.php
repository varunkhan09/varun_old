...
$query = "create table DetailsTable (Name varchar(60), Age int(2), Orientation varchar(6), School varchar(30), College varchar(30), Income varchar(20), UserId varchar(20) primary key, password varchar(600))";
$flag = mysql_query($query);
